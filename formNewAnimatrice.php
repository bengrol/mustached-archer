...
<form id="formNew" action="editeAnimatrice.php?action=new" method="POST" ng-app="formAnimApp">
        ...
        <div class="panel-body">
            <div class="panel  col-md-12">
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group"><button  form="formNew" class="btn btn-default"  value="Sauvegarder Infos" name="onCreate">Sauvegarder Infos</button></div>
                </div>
            </div>
            <div class="col-md-6">
